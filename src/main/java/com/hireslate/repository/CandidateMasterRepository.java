...
public class CandidateMasterRepository {
	...
	public void insert(CandidateMasterEntity candidate) {
		String sql="insert into candidate_master (User_Id,Candidate_Institute,Candidate_Course_StartYear,Candidate_Course_EndYear,Course_Id,Stream_Id,Candidate_LinkedIn,Candidate_Github) values ('"+candidate.getUserId()+"','"+candidate.getCandidateInstitute()+"','"+candidate.getCandidateCourseStartYear()+"','"+candidate.getCandidateCourseEndYear()+"','"+candidate.getCourseId()+"','"+candidate.getStreamId()+"','"+candidate.getCandidateLinkedIn()+"','"+candidate.getCandidateGithub()+"')";                                                        
