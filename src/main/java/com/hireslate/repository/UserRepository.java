...
public class UserRepository {
	...
	public void insert(UserEntity user) {
		String sql = "insert into user (User_Fname,User_Mname,User_Lname,User_DateOfBirth,User_AddressLine,User_AddressLandmark,User_Pincode,User_City,User_State,User_Gender,User_Role,User_UserName,User_Password) values ('"
				+user.getUserFname()+"','"+user.getUserMname()+"','"+user.getUserLname()+"','"+user.getUserDateOfBirth()+"','"+user.getUserAddressLine()
				+"','"+user.getUserAddressLandmark()+"','"+user.getUserPincode()+"','"+user.getUserCity()+"','"+user.getUserState()+"','"
				+user.getUserGender()+"','"+user.getUserRole()+"','"+user.getUserUserName()+"','"+user.getUserPassword()+"')";                                       
