...
public class StreamMasterController {
	...
	public String showCreateStreamMasterForm(Model model) {
		List<CourseMasterEntity> courseMasterEntities = courseMasterService.viewCourseMaster();
		model.addAttribute("courses", courseMasterEntities);
