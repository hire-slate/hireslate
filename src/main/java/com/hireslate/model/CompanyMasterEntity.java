...
public class CompanyMasterEntity {
	...
	private String companyContact,companyCity;
	...
	public CompanyMasterEntity(int companyId, int companyPincode, String companyName, String companyWebsite,
			...
			String companyPancardPhoto, String companyLogo, String companyDocument, String companyContact,String companyCity) {
		super();
