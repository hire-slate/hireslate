					...
					<li class="dropdown user user-menu"><a href="#"
						...
						<ul class="dropdown-menu">
							...
							<li class="user-footer">
								<div class="pull-left">
									<a href="/user/company/edit-companyprofile" class="btn btn-default btn-flat">Edit Profile</a>
								</div>
