        	...
        	<div class="col-xs-12">
             ...
             <table id="streamTable" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><span ><a href="/admin/stream-master/edit/${variable.streamId}"><i class="fa fa-edit"></i></a></span></td>
                  <td><span ><a href="/admin/stream-master/delete/${variable.streamId}"><i class="fa fa-trash-o"></i></a></span></td>
               	  <td><%= ++i %></td>
