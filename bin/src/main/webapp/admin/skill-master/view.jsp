      	...
      	<div class="row" style="margin-top: 20px">
        	<div class="col-xs-12">
             ...
             <table id="skillTable" class="table table-bordered table-striped">
                ...
                <tbody>
				<% int i = 0; %>                
                <c:forEach items="${skillMasterEntity}" var="variable">
                <tr>
                    
                  <td><input type = "checkbox">
                  <td><span ><a href="/admin/skill-master/edit/${variable.skillId}"><i class="fa fa-edit"></i></a></span></td>
                  <td><span ><a href="/admin/skill-master/delete/${variable.skillId}"><i class="fa fa-trash-o"></i></a></span></td>
               	  <td><%= ++i %></td>
